        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="font-black text-2xl text-gray-900">Connexion Supporter</h1>
              <p className="text-gray-500 text-sm mt-2">Accedez a votre espace personnel</p>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                Pas encore inscrit ?{' '}
                <Link to="/auth/fan-register" className="text-[#00694c] font-semibold hover:underline">
                  Creer un compte
                </Link>
              </p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              <p className="text-xs text-gray-400 text-center">
                Identifiants de demonstration :<br />
                <span className="font-mono font-semibold">fan@sporena.com</span> / <span className="font-mono font-semibold">demo123</span>
              </p>
            </div>
          </div>
        </div>
